...
/**
 * Controller that handles api requests on questions, quizzes and quizquestion
 * tables
 * 
...
public class QuestionController {
	 ...
	 *            HttpSession object to validate user session
	 * @param qid
	 * @return Question with that particular id {@link QuestionService}
	 *         {@link AuthenticateService}
	 * @throws UnauthorizedException
	 *             Throws when user doesn't have a valid session
	 */
	 ...
	 *            HttpSession object to validate user session
	 * @param qid
	 * @return Deletes and renders a home page {@link QuestionService}
	 *         {@link AuthenticateService}
	 * @throws NotFoundException
	 *             Throws when question id is not found
	 * @throws BadRequestException
	 *             Throws when question id id not given
	 * @throws UnauthorizedException
	 *             Throws when user doesn't have valid session
	 */
	 ...
	 * @param qid
	 * @param question
	 * @return Renders a home page {@link QuestionService}
	 *         {@link AuthenticateService}
	 * @throws BadRequestException
	 *             Throws when question id id not given
	 * @throws UnauthorizedException
	 ...
	 * @param categoryId
	 * @param difficultyId
	 * @return Renders a HTML page setQuestions after successful addition
	 *         {@link QuestionService} {@link AuthenticateService}
	 * @throws BadRequestException
	 *             Throws when any parameter is not passed
	 * @throws UnauthorizedException
	 *             Throws when user doesn't have a valid session
	 */
	 ...
	 * @param session
	 *            HttpSession object to validate user session
	 * @return List of quizzes generated {@link QuizService}
	 *         {@link AuthenticateService}
	 * @throws UnauthorizedException
	 *             Throws when user doesn't have a valid session
	 */
